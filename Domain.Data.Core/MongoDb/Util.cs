...
namespace Domain.Data.Core.MongoDb
{
    ...
    public static class Util<U>
    {
        ...
        {
            //return ConfigurationManager.ConnectionStrings["MongoServerSettings"TX.Infrastructure.CrossCutting.CommonUtils.Constants.MongoDbAppSettings.GlobalDbMongoConnectionStringName].ConnectionString;            
